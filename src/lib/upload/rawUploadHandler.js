// src/lib/upload/rawUploadHandler.js
/**
 * Raw upload handler for large file uploads
...
/**
 * Handle raw Node.js request for large file uploads
 * This bypasses Next.js body size limits by processing the raw stream
 */
export async function handleRawUpload(req, res) {
  try {
